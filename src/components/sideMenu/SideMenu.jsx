...
const SideMenu = ({ darkMode, setDarkMode }) => {
  return (
    <div className="SideMenu">
      ...
      />
      <div className="home">
        <div className="explore-icon">{/* <FaHome /> */}</div>
        <p className="home-text">Home</p>
      </div>
      <div className="explore">
        <div className="explore-icon">{/* <FaHashtag /> */}</div>
        <p className="explore-text">Explore</p>
      </div>
      <div className="notification">
        <div className="explore-icon">{/* <MdNotificationsActive /> */}</div>
        <p className="notification-text">Notification</p>
      </div>
      <div className="messages">
        <div className="explore-icon">{/* <TbMessages /> */}</div>
        <p className="messages-text">Messages</p>
      </div>
      <div className="messages">
        <div className="explore-icon">{/* <BsBookmarkStar /> */}</div>
        <p className="messages-text">Bookmarks</p>
      </div>
      <div className="messages">
        <div className="explore-icon">{/* <BsCardList /> */}</div>
      ...
      <div className="messages">
        <div className="explore-icon">{/* <CgMoreO /> */}</div>
